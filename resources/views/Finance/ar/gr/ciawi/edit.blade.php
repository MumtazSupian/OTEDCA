...
@section('title', 'GR Ciawi - Edit Piutang')
...
@section('content')
    <div style="padding: 16px; max-width: 1100px; margin: 0 auto; box-sizing: border-box; background-color: #ffffff;">
        ...
        <div class="page-header" style="margin-bottom: 16px; border-bottom: 2px solid #f3f4f6; padding-bottom: 8px;">
            <div>
                <h1 class="page-title" style="color: #dc2626 !important; font-weight: 700 !important; font-size: 20px; margin: 0;">Edit Data Piutang - GR Ciawi</h1>
                <p class="page-subtitle" style="color: #6b7280; font-size: 12px; margin-top: 2px;">Perbarui detail piutang konsumen cabang Ciawi.</p>
            </div>
        </div>
        ...
        <style>
            ...
            .btn-pilih-perusahaan {
                background: #dc2626; color: #ffffff !important; font-weight:800;
                border: none;
                padding: 6px 12px;
                border-radius: 6px;
                cursor: pointer;
        ...
        <form method="POST" action="{{ url('/gr/ciawi/' . ($id ?? ($record->id ?? ''))) }}" id="formEditPiutang">
            @csrf
            @method('PUT')
