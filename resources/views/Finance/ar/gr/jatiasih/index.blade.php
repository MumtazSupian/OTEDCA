                                    ...
                                    <tbody id="perusahaan_list">
                                        @foreach($perusahaans as $p)
                                            <tr>
                                                <td>{{ $p->nama }}</td>
                                                <td style="text-align: center;">
                                                    <button type="button" class="btn-pilih-perusahaan" onclick="pilihPerusahaan('{{ $p->id }}', '{{ $p->nama }}')">Pilih</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
