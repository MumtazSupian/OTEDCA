...
@section('content')
    ...
    <div class="modal" style="max-width: 1100px; width: 95%;">
        ...
        <div class="modal-body">
            ...
            <form id="createForm" method="POST" action="{{ url('/gr/cianjur') }}">
                @csrf
                <div class="form-grid"
