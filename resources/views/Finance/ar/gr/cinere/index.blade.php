...
@section('title', 'GR Cinere - Rekapitulasi Piutang')
...
@section('content')
    ...
    <div class="modal" style="max-width: 1100px; width: 95%;">
        ...
        <div class="modal-body">
            ...
            <form id="createForm" method="POST" action="{{ url('/gr/cinere') }}">
                @csrf
                <div class="form-grid"
