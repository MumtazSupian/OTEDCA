...
<div style="width: 100%; box-sizing: border-box; overflow-x: hidden; padding: 20px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 2px solid #d2d6de; padding-bottom: 10px; margin-bottom: 20px;">
        <h2 style="margin: 0; font-size: 24px; font-weight: 500; color: #333;">Edit <span style="font-size: 16px; color: #777;">Teknisi</span></h2>
    ...
    <div style="background: #fff; border: none; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); max-width: 600px; margin: 0 auto; overflow: hidden;">
        ...
        <div style="padding: 20px 25px; border-bottom: 1px solid #f0f2f5; background: #f8fafc;">
            <h3 style="margin: 0; font-size: 16px; color: #334155; font-weight: 600;"><i class="fas fa-edit" style="color: #f59e0b; margin-right: 8px;"></i>Form Edit Data Teknisi</h3>
        </div>

        <form action="{{ route('service.service-ac.ac.teknisi_update', $teknisi->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div style="padding: 25px;">
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="text" name="nama" value="{{ $teknisi->nama }}" required style="width: 100%; padding: 12px 15px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 14px; box-sizing: border-box; background: #f8fafc; color: #334155; outline: none; transition: all 0.3s;" onfocus="this.style.borderColor='#f59e0b'; this.style.backgroundColor='#fff'; this.style.boxShadow='0 0 0 3px rgba(245, 158, 11, 0.1)';" onblur="this.style.borderColor='#e2e8f0'; this.style.backgroundColor='#f8fafc'; this.style.boxShadow='none';">
                </div>
            ...
            <div style="border-top: 1px solid #f0f2f5; padding: 20px 25px; text-align: right; background: #fff;">
                ...
                <button type="submit" style="background: linear-gradient(135deg, #f59e0b, #d97706); color: #fff; border: none; padding: 10px 25px; border-radius: 30px; cursor: pointer; font-size: 13px; font-weight: 600; box-shadow: 0 4px 10px rgba(245, 158, 11, 0.3); transition: all 0.2s;" onmouseover="this.style.transform='translateY(-1px)'; this.style.boxShadow='0 6px 15px rgba(245, 158, 11, 0.4)';" onmouseout="this.style.transform='none'; this.style.boxShadow='0 4px 10px rgba(245, 158, 11, 0.3)';">Simpan Perubahan</button>
            </div>
        </form>
    </div>
</div>
