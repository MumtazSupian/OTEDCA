...
<div style="width: 100%; box-sizing: border-box; overflow-x: hidden; padding: 20px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        <h2 style="margin: 0; font-size: 24px; font-weight: 500; color: #333;">Sumber <span style="font-size: 16px; color: #777;">Sumber Data</span></h2>
    ...
    <div style="background: #fff; border: 1px solid #ddd; border-radius: 4px; border-top: 3px solid #3c8dbc; box-shadow: 0 1px 1px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 10px 15px; border-bottom: 1px solid #f4f4f4; display: flex; justify-content: space-between; align-items: center;">
            <h3 style="margin: 0; font-size: 18px; color: #444;">Data Sumber</h3>
            <a href="{{ url('/sales/leads/sumber/create') }}" style="background: #3c8dbc; color: #fff; padding: 6px 12px; text-decoration: none; border-radius: 3px; font-size: 12px;">
        ...
        <div style="padding: 15px;">
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #f4f4f4; background-color: {{ $index % 2 == 0 ? '#fff' : '#f9f9f9' }};">
                            ...
                            <td style="padding: 10px; border: 1px solid #f4f4f4;">{{ $item->nama_sumber }}</td>
                            ...
                            <td style="padding: 10px; text-align: center; border: 1px solid #f4f4f4;">
                                <div style="display: flex; justify-content: center; align-items: center; gap: 5px;">
                                    <a href="{{ url('/sales/leads/sumber/' . $item->id . '/edit') }}" style="background: #3c8dbc; color: #fff; padding: 4px 8px; border-radius: 3px; text-decoration: none; font-size: 12px; ; display: inline-flex; align-items: center; justify-content: center;">
                                    ...
                                    <form action="{{ url('/sales/leads/sumber/' . $item->id) }}" method="POST" style="margin: 0; padding: 0;" onsubmit="return confirm('Yakin ingin menghapus sumber ini?');">
                                    @csrf
                                    @method('DELETE')
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 15px; font-size: 13px; color: #777;">
                <div>Showing 1 to {{ count($sumbers) }} of {{ count($sumbers) }} entries</div>
