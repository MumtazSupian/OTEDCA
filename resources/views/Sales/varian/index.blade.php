                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.varians.destroy', $item) }}" method="POST" style="display:inline-flex; margin-left:8px;">
                                @csrf @method('DELETE')
                                <button type="submit" class="btn-secondary" style="background:#ef4444; color:#1e293b; font-weight:800; border:none;" onclick="return confirm('Yakin hapus varian ini?')">Hapus</button>
                            </form>
                        </td>
                    </tr>
                @empty
