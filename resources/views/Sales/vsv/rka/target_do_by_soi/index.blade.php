...
@section('content')
    <div style="padding: 20px; max-width: 1300px; margin: 0 auto;">
        ...
        <p style="text-align:center; color: #64748b; margin-bottom:20px; font-size: 14px;">Manajemen rencana tahunan berdasarkan Source of Inquiry</p>
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:15px; padding: 0 10px;">
            <div style="display:flex; gap:10px; align-items:center;">
                ...
                <a href="{{ route('rka.target-do-by-soi.index') }}"
                ...
                <a href="{{ route('rka.target-do-by-soi.pdf') }}"
                ...
                <a href="{{ route('rka.target-do-by-soi.excel') }}"
            ...
            <a href="{{ route('rka.target-do-by-soi.create') }}"
                        ...
                        <tr style="background:{{ $loop->iteration % 2 == 0 ? '#f7faff' : '#ffffff' }}; border-bottom: 1px solid var(--border-color, #e2e8f0);">
                            ...
                            <td style="border: 1px solid #cbd5e1; padding: 6px;">
                                <div style="display: flex; gap: 4px; justify-content: center;">
                                    <a href="{{ route('rka.target-do-by-soi.edit', $row->id) }}" 
                                    ...
                                    <form action="{{ route('rka.target-do-by-soi.destroy', $row->id) }}" 
                                          method="POST" 
