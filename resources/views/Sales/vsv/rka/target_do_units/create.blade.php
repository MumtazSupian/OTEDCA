                ...
                <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px;">
                    ...
                    @foreach($months as $key => $label)
                        <div style="background: #f7fafc; padding: 10px; border-radius: 12px; border: 1px solid #e2e8f0; text-align: center;">
                            ...
                            <input type="number" name="{{ $key }}" min="0" value="0" style="width: 100%; padding: 8px; border: 1px solid #cbd5e0; border-radius: 8px; font-size: 14px; text-align: center; color: #2d3748;">
                        </div>
                    @endforeach
                </div>
