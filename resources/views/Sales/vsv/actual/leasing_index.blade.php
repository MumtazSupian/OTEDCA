...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .table-custom thead tr th {
        ...
        padding: 11px 14px; border-bottom: 2px solid #f87171; vertical-align: middle;
...
<div class="page-wrapper">
    ...
    <div class="page-header-wrap">
        ...
        <h1 class="page-header-title">{{ $pageTitle ?? 'Actual Sales By Leasing' }}</h1>
        <p class="page-header-subtitle">{{ $subTitle ?? 'Monitoring data aktual penjualan berdasarkan leasing' }}</p>
    </div>
            ...
            <table class="table-custom">
                <thead>
                    <tr>
                        ...
                        <th style="width:25%;">Leasing</th>
                        <th class="text-center" style="width:8%;">SPK</th>
                        <th class="text-center" style="width:8%;">DO</th>
                        <th class="text-center" style="width:9%;">Delivery</th>
                    </tr>
                </thead>
                <tbody>
                    @php 
                    ...
                    @forelse($data as $row)
                        ...
                        @endphp
                        <tr>
                            <td class="td-pos">{{ $row->Posisi }}</td>
                            <td class="td-name">{{ $row->Nama }}</td>
                            <td class="td-leasing">{{ $row->Leasing }}</td>
                        ...
                        <tr>
                            <td colspan="6">
                                <div class="empty-state">
                                    ...
                                    <p>
                                        @if(empty(request('branch_manager')) || empty(request('sales_head')))
                                            Silakan pilih Branch Manager dan Sales Head terlebih dahulu untuk menampilkan data.
                                        @else
