...
@section('content')
    <div
        ...
        <div style="text-align: center; margin-bottom: 40px;">
            <h1
                style="color: #1e293b; font-size: 26px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; margin: 0;">
                DASHBOARD ACTIVITY
            </h1>
            <div style="width: 60px; height: 4px; background: #dc2626; margin: 12px auto; border-radius: 10px;"></div>
            <p style="color: #64748b; font-size: 14px; margin-top: 5px;">Kelola rencana dan realisasi aktivitas marketing
