    ...
    <div style="padding: 40px 20px; display: flex; flex-direction: column; align-items: center; min-height: 100vh;">
        <div style="text-align: center; margin-bottom: 30px;">
            ...
            <p style="text-align:center; color: #e1e1e1; font-size: 13px; margin-bottom: 15px;">
                Mengupdate data untuk Cabang: <strong style="color: #ffffff;">{{ Auth::user()->cabang }}</strong>
            </p>
        </div>
            ...
            <form id="formEditActivity" action="{{ route('activity.actual.update', $activity->id) }}" method="POST">
                ...
                <div style="display: grid; gap: 30px;">
                    ...
                    <div>
                        ...
                        <input type="text" name="platform_lokasi" value="{{ $activity->platform_lokasi }}" required style="width: 100%; padding: 14px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 10px;">
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 30px;">
                        <div>
                            ...
                            <input type="date" name="tanggal" value="{{ $activity->tanggal }}" required style="width: 100%; padding: 12px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 8px;">
                        </div>
                        <div>
                            <label style="display: block; margin-bottom: 10px; color: #2d3748; font-weight: 700; font-size: 13px;">JAM</label>
                            <input type="time" name="jam" value="{{ \Carbon\Carbon::parse($activity->jam)->format('H:i') }}" required style="width: 100%; padding: 12px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 8px;">
                        </div>
                        <div>
                            <label style="display: block; margin-bottom: 10px; color: #2d3748; font-weight: 700; font-size: 13px;">SALES / SHIFT</label>
                            <input type="number" name="jml_sales_shift" value="{{ $activity->jml_sales_shift }}" required style="width: 100%; padding: 12px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 8px;">
                        </div>
                    </div>

                    <div>
                        <label style="display: block; margin-bottom: 10px; color: #2d3748; font-weight: 700; font-size: 13px;">PIC KEGIATAN</label>
                        <input type="text" name="pic" value="{{ $activity->pic }}" required style="width: 100%; padding: 14px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 10px;">
                    </div>
                    ...
                    <div style="background: #fff5f5; padding: 25px; border-radius: 15px; border: 1px solid #fed7d7;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-bottom: 20px;">
                            <div><span style="font-size: 11px; font-weight: 800; color: #c53030;">TARGET P</span><input type="number" name="target_p" value="{{ $activity->target_p }}" style="width: 100%; padding: 12px; border: 1px solid #feb2b2; border-radius: 8px; margin-top: 5px;"></div>
                            <div><span style="font-size: 11px; font-weight: 800; color: #c53030;">TARGET HP</span><input type="number" name="target_hp" value="{{ $activity->target_hp }}" style="width: 100%; padding: 12px; border: 1px solid #feb2b2; border-radius: 8px; margin-top: 5px;"></div>
                            <div><span style="font-size: 11px; font-weight: 800; color: #c53030;">TARGET SPK</span><input type="number" name="target_spk" value="{{ $activity->target_spk }}" style="width: 100%; padding: 12px; border: 1px solid #feb2b2; border-radius: 8px; margin-top: 5px;"></div>
                        </div>
                    ...
                    <div style="display: flex; gap: 30px;">
                        <div style="flex: 1;">
                            ...
                            <input type="number" name="total_cost" value="{{ $activity->total_cost }}" required style="width: 100%; padding: 14px; background: #fffaf0; border: 2px solid #feebc8; border-radius: 10px;">
                        </div>
                        <div style="flex: 2;">
                            <label style="display: block; margin-bottom: 10px; color: #2d3748; font-weight: 700; font-size: 13px;">KETERANGAN</label>
                            <textarea name="keterangan" rows="2" style="width: 100%; padding: 14px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 10px; font-family: inherit;">{{ $activity->keterangan }}</textarea>
                        </div>
                    </div>
