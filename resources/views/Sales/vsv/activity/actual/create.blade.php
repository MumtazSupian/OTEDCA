@extends('layouts.app')
@section('title', 'Target & Budget Matrix - Activity Actual')
...
<div class="target-matrix-wrapper">
    <h1 class="page-title">PENGATURAN TARGET & BUDGET (ACTUAL)</h1>
    <p class="page-subtitle">Input dan Sesuaikan Target (INQ, SPK, DO) & Total Budget per Model serta Kategori Aktivitas</p>
