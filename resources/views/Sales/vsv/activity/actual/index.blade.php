                    ...
                    @foreach ($data as $item)
                        <tr style="background:#fff; border-bottom: 1px solid #000;">
                            ...
                            <td style="border: 1px solid #cbd5e1; padding: 5px;">
                                <a href="{{ route('activity.actual.edit', $item->id) }}" style="background: #dc2626;  padding: 2px 5px; border-radius: 4px; font-size: 10px; text-decoration:none; font-weight:700; margin-right:2px; text-transform: uppercase;">EDIT</a>
