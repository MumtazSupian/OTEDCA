...
<div class="activity-wrapper">
    <h1 class="page-title">ACTIVITY PLAN</h1>
    <p class="page-subtitle">Summary Marketing Activity & ITS Performance Matrix Plan</p>

    <div class="toolbar-wrap">
        <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
            <a href="{{ url('/activity/dashboard') }}" class="btn-nav">← Dashboard</a>
            <a href="{{ url()->current() }}" class="btn-nav">🔄 Refresh</a>
            <a href="{{ route('activity.plan.pdf', ['cabang' => $selectedCabang, 'bulan' => $currMonthNum, 'tahun' => $currYear]) }}" class="btn-nav btn-pdf">📄 Export PDF</a>
            <a href="{{ route('activity.plan.excel', ['cabang' => $selectedCabang, 'bulan' => $currMonthNum, 'tahun' => $currYear]) }}" class="btn-nav btn-excel">📊 Excel</a>
        </div>
    ...
    <div>
        <span class="branch-active-pill">
            ...
            <span style="background: rgba(37, 99, 235, 0.15); color: #2563eb; padding: 2px 6px; border-radius: 4px; font-size: 0.68rem; margin-left: 6px; font-weight: 800;">
                PLAN / PERENCANAAN
            </span>
        </span>
    </div>
            ...
            <thead>
                <tr>
                    ...
                    <th rowspan="3" class="th-main-left" style="width: 90px; vertical-align: middle;">
                        QTY<br>ACTIVITIES
                        <a href="{{ route('activity.plan.create', ['cabang' => $activeCabangTarget, 'bulan' => $currMonthNum, 'tahun' => $currYear, 'target' => 'qty']) }}" class="btn-edit-header" title="Input / Edit QTY Activities">
                ...
                <tr>
                    ...
                    <th rowspan="2" class="th-sub-cost" style="min-width: 135px; vertical-align: middle;">
                        TOTAL BUDGET
                        <a href="{{ route('activity.plan.create', ['cabang' => $activeCabangTarget, 'bulan' => $currMonthNum, 'tahun' => $currYear, 'target' => 'budget']) }}" class="btn-edit-header btn-edit-purple" title="Input / Edit Total Budget">
                    ...
                    <th rowspan="2" class="th-sub-cost" style="min-width: 130px; vertical-align: middle;">
                        PER SPK
                        <a href="{{ route('activity.plan.create', ['cabang' => $activeCabangTarget, 'bulan' => $currMonthNum, 'tahun' => $currYear, 'target' => 'perspk']) }}" class="btn-edit-header btn-edit-purple" title="Input / Edit Cost Per SPK">
                            <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                            </svg>
                ...
                <tr class="tr-subcols">
                    ...
                    <th class="th-tgt" style="width: 54px;">
                        TGT
                        <a href="{{ route('activity.plan.create', ['cabang' => $activeCabangTarget, 'bulan' => $currMonthNum, 'tahun' => $currYear, 'target' => 'inq']) }}" class="btn-edit-header" title="Input / Edit Target INQ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                            </svg>
                    ...
                    <th class="th-tgt" style="width: 54px;">
                        TGT
                        <a href="{{ route('activity.plan.create', ['cabang' => $activeCabangTarget, 'bulan' => $currMonthNum, 'tahun' => $currYear, 'target' => 'spk']) }}" class="btn-edit-header" title="Input / Edit Target SPK">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                            </svg>
                    ...
                    <th class="th-tgt" style="width: 54px;">
                        TGT
                        <a href="{{ route('activity.plan.create', ['cabang' => $activeCabangTarget, 'bulan' => $currMonthNum, 'tahun' => $currYear, 'target' => 'do']) }}" class="btn-edit-header" title="Input / Edit Target DO">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                            </svg>
...
<script>
    function applyFilters() {
        ...
        let url = '{{ route("activity.plan.index") }}?cabang=' + encodeURIComponent(cb) + '&bulan=' + encodeURIComponent(bln) + '&tahun=' + encodeURIComponent(thn);
        window.location.href = url;
    }

    function confirmDeleteRecord(formId) {
        Swal.fire({
            title: 'Hapus Data Rencana Aktivitas?',
