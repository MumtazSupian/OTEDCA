@extends('layouts.app')
@section('title', 'Target & Budget Matrix - Activity Plan')
...
<div class="target-matrix-wrapper">
    <h1 class="page-title">PENGATURAN TARGET & BUDGET (PLAN)</h1>
    <p class="page-subtitle">Input dan Sesuaikan Rencana Target (INQ, SPK, DO) & Total Budget per Model serta Kategori Aktivitas</p>
