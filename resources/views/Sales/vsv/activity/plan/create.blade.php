...
@section('content')
    <div style="padding: 40px 20px; display: flex; flex-direction: column; align-items: center; min-height: 100vh;">
        ...
        <div
            style="background: #ffffff; border-radius: 20px; padding: 30px; color: #333; box-shadow: 0 15px 35px rgba(0,0,0,0.15); width: 100%; max-width: 900px; box-sizing: border-box; overflow: hidden;">
            <form id="formActivity" action="{{ route('activity.plan.store') }}" method="POST">
                ...
                <div style="display: grid; width: 100%; box-sizing: border-box; box-sizing: border-box;  gap: 30px;">
                    <div style="display: flex; gap: 30px; width: 100%; box-sizing: border-box; box-sizing: border-box;">
                        <div style="flex: 1; min-width: 0; max-width: 100%; box-sizing: border-box; min-width: 0; box-sizing: border-box;">
                            <label
                                ...
                                Activity</label>
                            <select name="jenis_activity" required
                                style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 14px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 10px; color: #2d3748; font-size: 15px;">
                        ...
                        <div style="flex: 1; min-width: 0; max-width: 100%; box-sizing: border-box; min-width: 0; box-sizing: border-box;">
                            ...
                            <select name="activity" required
                                style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 14px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 10px; color: #2d3748; font-size: 15px;">
                                <option value="D_MARKETING" {{ old('activity') == 'D_MARKETING' ? 'selected' : '' }}>D. MARKETING</option>
                                <option value="EXHIBITION" {{ old('activity') == 'EXHIBITION' ? 'selected' : '' }}>EXHIBITION</option>
                                <option value="MOVING_EXHIBITION" {{ old('activity') == 'MOVING_EXHIBITION' ? 'selected' : '' }}>MOVING EXHIBITION</option>
                                <option value="SHOWROOM_EVENT" {{ old('activity') == 'SHOWROOM_EVENT' ? 'selected' : '' }}>SHOWROOM EVENT</option>
                                <option value="GROUP_PRESENTATION" {{ old('activity') == 'GROUP_PRESENTATION' ? 'selected' : '' }}>GROUP PRESENTATION</option>
                                <option value="EVENT_TEST_DRIVE" {{ old('activity') == 'EVENT_TEST_DRIVE' ? 'selected' : '' }}>EVENT TEST DRIVE</option>
                                <option value="OPEN_TABLE" {{ old('activity') == 'OPEN_TABLE' ? 'selected' : '' }}>OPEN TABLE</option>
                                <option value="CETAK_FLYER" {{ old('activity') == 'CETAK_FLYER' ? 'selected' : '' }}>CETAK FLYER</option>
                            </select>
                        </div>
                    </div>
                    <div>
                        <label
                            ...
                            / Lokasi</label>
                        <input type="text" name="platform_lokasi" value="{{ old('platform_lokasi') }}" required
                            style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 14px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 10px;"
                    ...
                    <div style="background: #f0f9ff; padding: 25px; border-radius: 15px; border: 1px solid #bee3f8;">
                        <h3
                            style="color: #dc2626; margin-top: 0; font-size: 14px; margin-bottom: 20px; font-weight: 800; border-bottom: 2px solid #bee3f8; padding-bottom: 10px; display: inline-block; text-transform: uppercase;">
                            DISPLAY UNIT</h3>
                        <div style="display: flex; gap: 30px; width: 100%; box-sizing: border-box; box-sizing: border-box;">
                            <div style="flex: 1; min-width: 0; max-width: 100%; box-sizing: border-box; min-width: 0; box-sizing: border-box;">
                                <label
                                ...
                                <select id="jenis_unit" name="jenis_unit" required
                                    style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 12px; background: white; border: 1px solid #cbd5e0; border-radius: 8px;">
                            ...
                            <div style="flex: 1; min-width: 0; max-width: 100%; box-sizing: border-box; min-width: 0; box-sizing: border-box;">
                                <label
                                    ...
                                    Unit</label>
                                <select id="type_unit" name="type_unit" required
                                    style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 12px; background: white; border: 1px solid #cbd5e0; border-radius: 8px;"></select>
                            </div>
                        </div>
                    </div>
                    <div style="display: grid; width: 100%; box-sizing: border-box; box-sizing: border-box;  grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 30px;">
                        <div>
                            ...
                            <input type="date" name="tanggal" value="{{ old('tanggal', date('Y-m-d')) }}" required
                                style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 12px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 8px;">
                        </div>
                        <div>
                            <label
                            ...
                            <input type="time" name="jam" required
                                ...
                                style="width: 100%; box-sizing: border-box; padding: 12px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 8px;">
                        </div>
                        <div>
                            <label
                                style="display: block; margin-bottom: 10px; color: #2d3748; font-weight: 700; font-size: 13px;">SALES
                                / SHIFT</label>
                            <input type="number" name="jml_sales_shift" placeholder="0" required value="{{ old('jml_sales_shift') }}"
                                style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 12px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 8px;">
                        </div>
                    </div>
                    <div>
                        <label
                            ...
                            KEGIATAN</label>
                        <input type="text" name="pic" required value="{{ old('pic') }}"
                            style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 14px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 10px;"
                    ...
                    <div style="background: #fff5f5; padding: 25px; border-radius: 15px; border: 1px solid #fed7d7;">
                        ...
                        <div style="display: grid; width: 100%; box-sizing: border-box; box-sizing: border-box;  grid-template-columns: repeat(3, 1fr); gap: 20px; margin-bottom: 20px;">
                            <div><span style="font-size: 11px; font-weight: 800; color: #c53030;">TARGET P</span><input
                                    type="number" name="target_p" required value="{{ old('target_p', 0) }}"
                                    style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 12px; border: 1px solid #feb2b2; border-radius: 8px; margin-top: 5px;">
                            </div>
                            <div><span style="font-size: 11px; font-weight: 800; color: #c53030;">TARGET HP</span><input
                                    type="number" name="target_hp" required value="{{ old('target_hp', 0) }}"
                                    style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 12px; border: 1px solid #feb2b2; border-radius: 8px; margin-top: 5px;">
                            </div>
                            <div><span style="font-size: 11px; font-weight: 800; color: #c53030;">TARGET SPK</span><input
                                    type="number" name="target_spk" required value="{{ old('target_spk', 0) }}"
                                    style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 12px; border: 1px solid #feb2b2; border-radius: 8px; margin-top: 5px;">
                            </div>
                        </div>
                        <div style="display: grid; width: 100%; box-sizing: border-box; box-sizing: border-box;  grid-template-columns: repeat(4, 1fr); gap: 15px;">
                            <input type="number" name="actual_p" placeholder="Actual P" value="{{ old('actual_p', 0) }}"
                                style="min-width: 0; max-width: 100%; box-sizing: border-box; padding: 12px; border: 1px solid #cbd5e0; border-radius: 8px; background: white;">
                            <input type="number" name="actual_hp" placeholder="Actual HP" value="{{ old('actual_hp', 0) }}"
                                style="min-width: 0; max-width: 100%; box-sizing: border-box; padding: 12px; border: 1px solid #cbd5e0; border-radius: 8px; background: white;">
                            <input type="number" name="actual_spk" placeholder="Actual SPK" value="{{ old('actual_spk', 0) }}"
                                style="min-width: 0; max-width: 100%; box-sizing: border-box; padding: 12px; border: 1px solid #cbd5e0; border-radius: 8px; background: white;">
                            <input type="number" name="actual_do" placeholder="Actual DO" value="{{ old('actual_do', 0) }}"
                                style="min-width: 0; max-width: 100%; box-sizing: border-box; padding: 12px; border: 1px solid #cbd5e0; border-radius: 8px; background: white;">
                        </div>
                    </div>
                    <div style="display: flex; gap: 30px; width: 100%; box-sizing: border-box; box-sizing: border-box;">
                        <div style="flex: 1; min-width: 0; max-width: 100%; box-sizing: border-box; min-width: 0; box-sizing: border-box;"><label
                                style="display: block; margin-bottom: 10px; color: #2d3748; font-weight: 700; font-size: 13px;">TOTAL
                                COST (Rp)</label><input type="number" name="total_cost" required value="{{ old('total_cost', 0) }}"
                                style="min-width: 0; max-width: 100%; box-sizing: border-box; width: 100%; box-sizing: border-box; padding: 14px; background: #fffaf0; border: 2px solid #feebc8; border-radius: 10px;"
                                placeholder="0"></div>
                        <div style="flex: 2;"><label
                            ...
                            <textarea name="keterangan" rows="2"
                                style="width: 100%; box-sizing: border-box; padding: 14px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 10px; font-family: inherit;"
