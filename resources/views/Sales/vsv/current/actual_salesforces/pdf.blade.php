...
<html>
<head>
    <title>Laporan Actual Salesforces</title>
    <style>
...
<body>
    ...
    @php
        // Daftar bulan untuk looping kolom agar seragam
    ...
    <table>
        ...
        <tbody>
            @foreach ($data as $row)
            <tr>
                <td style="text-align: left; padding-left: 10px;">{{ $row->grading }}</td>
