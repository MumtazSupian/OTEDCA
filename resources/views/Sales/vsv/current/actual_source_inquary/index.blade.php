...
@section('title', 'Actual Source Inquiry')
...
@section('content')
    <div style="padding: 20px; max-width: 1400px; margin: 0 auto;">
        <h2
            ...
            📈 ACTUAL SOURCE INQUIRY
        </h2>
        <p style="text-align:center; color: #64748b; margin-bottom:20px; font-size: 14px;">Monitoring data aktual berdasarkan sumber inquiry</p>
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:15px; padding: 0 10px;">
            <div style="display:flex; gap:10px; align-items:center;">
                ...
                <a href="{{ route('current.actual-source-inquary.pdf') }}"
                ...
                <a href="{{ route('current.actual-source-inquary.excel') }}"
            ...
            <a href="{{ route('current.actual-source-inquary.create') }}"
                        ...
                        <tr style="background:{{ $loop->iteration % 2 == 0 ? '#f7faff' : '#ffffff' }}; border-bottom: 1px solid var(--border-color, #e2e8f0);">
                            ...
                            <td style="border: 1px solid #cbd5e1; padding: 6px;">
                                <div style="display: flex; gap: 4px; justify-content: center;">
                                    <a href="{{ route('current.actual-source-inquary.edit', $row->id) }}"
                                    ...
                                    <form action="{{ route('current.actual-source-inquary.destroy', $row->id) }}" method="POST"
