...
<div style="padding: 40px 20px; display: flex; flex-direction: column; align-items: center; min-height: 100vh;">
    ...
    <div style="text-align: center; margin-bottom: 30px;">
        ...
        <p style="color: #64748b; font-size: 14px;">Perbarui angka aktual untuk sumber <strong style="color: #ffffff !important; font-weight: 800;">{{ $actualSourceInquary->source_inquary }}</strong></p>
    </div>
