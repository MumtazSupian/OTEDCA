...
<html>
<head>
    <title>Laporan Actual Source Inquiry</title>
    <style>
...
<body>
    ...
    <table>
        ...
        <tbody>
            @foreach ($data as $row)
            <tr>
                <td style="text-align: left; padding-left: 10px;">{{ $row->source_inquary ?? $row->source_inquiry }}</td>
