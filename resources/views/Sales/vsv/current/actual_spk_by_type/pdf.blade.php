...
<html>
<head>
    <title>Laporan Actual SPK By Type</title>
    <style>
...
<body>
    ...
    @php
        // Daftar bulan untuk looping kolom agar konsisten dengan data
        $monthsList = ['jan', 'feb', 'mar', 'apr', 'mei', 'jun', 'jul', 'agu', 'sep', 'okt', 'nov', 'des'];
        
        // Perhitungan Grand Total (Jika belum diproses di Controller)
        $grandTotals = [];
    ...
    <table>
        <thead>
            <tr>
                <th colspan="17" style="text-align: center; font-size: 16px; font-weight: bold; border: none; background-color: #ffffff;">
                    LAPORAN ACTUAL SPK BY TYPE
                </th>
            </tr>
            <tr>
                <th colspan="17" style="border: none; background-color: #ffffff; height: 15px;"></th>
            </tr>
            <tr>
                <th style="background-color: #cce5ff; font-weight: bold; text-align: center;">JENIS</th>
                <th style="background-color: #cce5ff; font-weight: bold; text-align: center;">TYPE UNIT</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: left; padding-left: 10px;">{{ $row->type_unit }}</td>
        ...
        <tfoot>
            <tr>
                <td colspan="4" style="background-color: #dc2626; color: #ffffff; font-weight: bold; text-align: right; padding-right: 15px;">GRAND TOTAL</td>
                @foreach ($monthsList as $m)
