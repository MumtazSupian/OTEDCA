...
<html>
<head>
    <title>Laporan Actual Inquiry By Type</title>
    <style>
...
<body>
    ...
    @php
        // Daftar bulan untuk looping kolom data
    ...
    <table>
        <thead>
            <tr>
                <th colspan="17" style="text-align: center; font-size: 16px; font-weight: bold; border: none; background-color: #ffffff;">
                    LAPORAN ACTUAL INQUIRY BY TYPE
                </th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th style="background-color: #cce5ff; font-weight: bold; text-align: center;">KATEGORI</th>
        ...
        <tbody>
            @foreach ($data as $row)
            <tr>
                <td style="text-align: left;">{{ $row->type_unit }}</td>
