...
<html>
<head>
    <title>Laporan Actual Sales By Leasing</title>
    <style>
...
<body>
    ...
    @php
        // Daftar bulan untuk looping kolom data agar konsisten
    ...
    <table>
        <thead>
            <tr>
                <th colspan="16" style="text-align: center; font-size: 16px; font-weight: bold; border: none; background-color: #ffffff;">
                    LAPORAN ACTUAL SALES BY LEASING
                </th>
            </tr>
            <tr>
            ...
            <tr>
                <th style="background-color: #cce5ff; font-weight: bold; text-align: center;">LEASING NAME</th>
        ...
        <tbody>
            @foreach ($data as $row)
            <tr>
                <td style="text-align: left; padding-left: 10px;">{{ $row->leasing_name }}</td>
