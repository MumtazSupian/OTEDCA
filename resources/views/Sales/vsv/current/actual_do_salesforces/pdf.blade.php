...
<body>
    ...
    @php
        // Definisi list bulan untuk mempermudah looping
        $monthsList = ['jan', 'feb', 'mar', 'apr', 'mei', 'jun', 'jul', 'agu', 'sep', 'okt', 'nov', 'des'];
        
        // Pastikan variabel $grandTotals dan $grandTotalAll sudah dipassing dari controller.
        // Jika belum, logic sum bisa diletakkan di sini seperti pada file sebelumnya.
    @endphp
    ...
    <table>
        <thead>
            ...
            <tr>
                <th style="background-color: #cce5ff; font-weight: bold; text-align: center;">GRADING</th>
        ...
        <tbody>
            @foreach ($data as $row)
            <tr>
                <td style="text-align: left;">{{ $row->grading }}</td>
