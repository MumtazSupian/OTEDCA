...
@section('title', 'Actual DO By Type')
...
@section('content')
    <div style="padding: 20px; max-width: 1400px; margin: 0 auto;">
        ...
        <p style="text-align:center; color: #64748b; margin-bottom:20px; font-size: 14px;">Monitoring data aktual Delivery Order berdasarkan tipe mobil</p>
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:15px; padding: 0 10px;">
            <div style="display:flex; gap:10px; align-items:center;">
                ...
                <a href="{{ route('current.actual-do-by-type.pdf') }}"
                ...
                <a href="{{ route('current.actual-do-by-type.excel') }}"
        ...
        <div
            ...
            <table width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="background:{{ $loop->iteration % 2 == 0 ? '#f7faff' : '#ffffff' }}; border-bottom: 1px solid var(--border-color, #e2e8f0);">
                            ...
                            <td style="border: 1px solid #cbd5e1; padding: 6px;">
                                <div style="display: flex; gap: 4px; justify-content: center;">
                                    <a href="{{ route('current.actual-do-by-type.edit', $row->id) }}"
                ...
                <tfoot style="background:#fef2f2; color:#7f1d1d; font-weight:800; font-weight:bold;">
                    <tr>
                        <td colspan="{{ Auth::user()->role !== 'SH' ? 5 : 4 }}" style="border: 1px solid #cbd5e1; padding: 10px; text-align: center;">GRAND TOTAL</td>
                        @foreach ($months as $m)
