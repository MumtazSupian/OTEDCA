            ...
            <table width="100%" cellpadding="8" cellspacing="0"
                ...
                <thead style="background:#fee2e2; color:#991b1b;">
                    <tr style="border-bottom:2px solid #f87171;">
                        ...
                        <th style="border: 1px solid #cbd5e1;">GRADING</th> {{-- Kolom Baru --}}
                ...
                <tbody>
                    @foreach ($data as $i => $d)
                        <tr
                            ...
                            <td style="border: 1px solid #cbd5e1;">{{ $d->nama_sales }}</td>
                            <td style="border: 1px solid #cbd5e1;">{{ $d->tanggal_masuk }}</td>
                            <td style="border: 1px solid #cbd5e1;">{{ $d->tanggal_evaluasi }}</td>
                            ...
                            <td style="border: 1px solid #cbd5e1; text-align:center;">
                                ...
                                <span
                                    style="padding: 4px 8px; border-radius: 4px; color: #1e293b; font-weight:800; font-weight: bold; font-size: 9px; background: {{ $color }}; white-space: nowrap; display: inline-block;">
                            ...
                            <td style="border: 1px solid #cbd5e1;">{{ $d->tanggal_keluar }}</td>
                            <td style="border: 1px solid #cbd5e1; white-space:nowrap;">
                                ...
                                <form action="{{ route('evaluasi.destroy', $d->id) }}" method="POST"
                                    ...
                                    <button type="button" onclick="confirmDelete('{{ $d->id }}')"
                                        style="background:#e53935;  border:none; padding:3px 7px; border-radius:4px; font-size:11px; cursor:pointer;">
                                        Hapus
                                    </button>
                                </form>
                            </td>
                ...
                <tfoot style="background:#fef2f2;  font-weight:bold;">
                    <tr>
                        <td colspan="13" style="border: 1px solid #cbd5e1; text-align: center;">GRAND TOTAL</td>
                        <td style="border: 1px solid #cbd5e1;">{{ $grandTotal }}</td>
