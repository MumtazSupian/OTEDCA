...
class AktualPoController extends Controller
{
    ...
    {
        $user = Auth::user();
        $query = \App\Models\Sales\vsv\leasing\AktualPo::query();
    ...
    public function edit($id) {
        ...
        return view('sales.vsv.leasing.aktual_po.edit', compact('data'));
    }
    ...
    public function update(Request $request, $id) {
        ...
        return redirect()->route('leasing.aktual-po.index')->with('success', 'Data PO diperbarui.');
    }
    ...
    public function exportPdf() {
        $data = $this->getFilteredQuery()->get();
        return Pdf::loadView('leasing.aktual_po.pdf', compact('data'))
            ->setPaper('a4', 'landscape')->download('Laporan-Aktual-PO.pdf');
    }
