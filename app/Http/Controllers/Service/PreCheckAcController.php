...
class PreCheckAcController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('service.service_ac.ac.pre_check', compact('tab', 'preCheckAcs', 'cabangs', 'teknisis', 'sas', 'perawatans'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('service.service_ac.ac.pre_check_edit', compact('data', 'cabangs', 'teknisis', 'sas', 'perawatans'));
    }
